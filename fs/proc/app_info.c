				 ...
				 int count, int *eof, void *data)
{
   ...
   sprintf(hw_version_sub_ver, "VER.%c", 'A'+(char)get_hw_sub_board_id());
	...
	"audio_property:\n%s\n"
	"touch_info:\n%s\n",
     appsboot_version, ker_ver, str_flash_nand_id, s_board_id, lcd_name,camera_id, ts_id, charge_flag, compass_gs_name, sensors_list_name, hw_version_id, wifi_device_name, bt_device_name, baseband_version, audio_property, touch_info);
#else
	len = snprintf(page, PAGE_SIZE, "APPSBOOT:\n"
	"%s\n"
	"KERNEL_VER:\n"
